...
export const INTERVIEW_CATEGORIES: InterviewCategory[] = [
  { name: "Flutter Fundamentals", slug: "fundamentals", icon: Puzzle },
  { name: "Flutter Widgets", slug: "widgets", icon: Boxes },
  { name: "Dart Questions", slug: "dart", icon: Target },
  { name: "State Management", slug: "state-management", icon: Zap },
  { name: "Async Programming", slug: "async-programming", icon: Timer },
  { name: "Navigation & Routing", slug: "navigation", icon: Compass },
  { name: "Flutter Performance", slug: "performance", icon: Rocket },
  { name: "Testing", slug: "testing", icon: FlaskConical },
  { name: "Firebase Integration", slug: "firebase", icon: Flame },
  { name: "Architecture", slug: "architecture", icon: Building2 },
  { name: "Advanced Flutter", slug: "advanced-flutter", icon: Brain },
];

export const DIFFICULTIES: Difficulty[] = ["Beginner", "Intermediate", "Advanced"];

// Dev-without-Supabase fallback — the DB (interview_questions table) is the
// source of truth once seeded; this array is only used when getSupabaseClient()
// returns null (no env vars configured) or a query fails.
