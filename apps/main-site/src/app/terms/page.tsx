...
export const metadata: Metadata = pageMetadata({ title: "Terms of Service", description: "Terms of service for bidev.dev.", path: "/terms" });
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-20">
      ...
      <div className="prose prose-invert max-w-none">
        ...
        <p>bidev.dev provides educational content, developer tools, and resources free of charge. You may use these for personal and commercial projects. You may not reproduce or republish our articles without attribution.</p>
        ...
        <h2>Content</h2>
        <p>Article content is the intellectual property of bidev.dev / Bilal Fali. Code snippets in articles may be used freely in your projects.</p>
        <h2>Changes</h2>
