    ...
    <div className="space-y-1.5">
      {(label || counter) && (
        <div className="flex items-center justify-between">
          ...
          {counter && (
            <span className={cn("text-xs", counter.current > counter.max ? "text-red-600" : "text-ink-faint")}>
      ...
      <textarea
        id={inputId}
        className={cn(
          "w-full bg-paper-raised border px-3 py-2 text-sm text-ink placeholder:text-ink-faint",
